  ...
  return (
    <section className="bg-black text-white">
      ...
      <div className="py-22 text-center bg-white">
        <h1 className="text-black mb-12 text-3xl sm:text-5xl lg:text-6xl">Highlighting Services with <span className="block font-semibold text-primary leading-20"> Impact & Clarity</span></h1>
